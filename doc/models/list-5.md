...
| `brandingDomain` | `unknown` | Required | Branding domain array |
| `productTransactions` | `unknown[]` | Required | Product Transactions array |
| `productFile` | `unknown` | Required | Product file array |
| `productAccountvault` | `unknown` | Required | Product Token array |
| `productRecurring` | `unknown` | Required | Product recurring array |
| `tags` | `unknown[]` | Required | Tags array |
| `terminals` | `unknown[]` | Required | Terminals array |
