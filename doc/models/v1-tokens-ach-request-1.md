...
| `accountNumber` | [`V1TokensAchRequest1AccountNumber \| null \| undefined`](../../doc/models/containers/v1-tokens-ach-request-1-account-number.md) | Optional | This is a container for one-of cases.<br>**Constraints**: *Minimum Length*: `4`, *Maximum Length*: `19`, *Pattern*: `^[\d]+$` |
