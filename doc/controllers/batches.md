...
| `fields` | [`Field25Enum[] \| undefined`](../../doc/models/field-25-enum.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
