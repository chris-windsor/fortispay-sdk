...
```ts
const transactionsCreditCardController = new TransactionsCreditCardController(client);
```
...
```ts
const body: V1TransactionsCcAuthOnlyKeyedRequest = {
  transactionAmount: 1,
...
try {
  ...
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAuthOnly(body);
...
```ts
const body: V1TransactionsCcAuthOnlyPrevTrxnRequest = {
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAuthOnlyPreviousTransaction(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcAuthOnlyTerminalRequest = {
  locationId: '11e95f8ec39de8fbdb0a4f1a',
  transactionAmount: 1,
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAuthOnlyTerminal(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcAuthOnlyTicketRequest = {
  transactionAmount: 1,
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAuthOnlyTicket(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcAuthOnlyTokenRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAuthOnlyTokenized(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcAuthOnlyWalletRequest = {
  transactionAmount: 1,
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAuthOnlyWallet(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcAvsOnlyKeyedRequest = {
  accountNumber: '5454545454545454',
  expDate: '0722',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAVS(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcAvsOnlyPrevTrxnRequest = {
  previousTransactionId: '11e95f8ec39de8fbdb0a4f1a',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAVSPreviousTransaction(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcAvsOnlyTerminalRequest = {
  locationId: '11e95f8ec39de8fbdb0a4f1a',
  terminalId: '11e95f8ec39de8fbdb0a4f1a',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAVSTerminal(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcAvsOnlyTicketRequest = {
  ticketId: '11e95f8ec39de8fbdb0a4f1a',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAVSTicket(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcAvsOnlyTokenRequest = {
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
  contactId: '11e95f8ec39de8fbdb0a4f1a',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAVSTokenized(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcAvsOnlyWalletRequest = {
  walletData: 'wallet_data2',
  walletProvider: WalletProviderEnum.GooglePay,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCAVSWallet(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcForceKeyedRequest = {
  accountNumber: '5454545454545454',
  expDate: '0722',
  authCode: 'abc123',
  checkinDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCForce(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcForcePrevTrxnRequest = {
  previousTransactionId: '11e95f8ec39de8fbdb0a4f1a',
  authCode: 'auth_code2',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCForcePreviousTransaction(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcForceTicketRequest = {
  ticketId: '11e95f8ec39de8fbdb0a4f1a',
  authCode: 'abc123',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCForceTicket(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcForceTokenRequest = {
  authCode: 'abc123',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCForceTokenized(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcForceWalletRequest = {
  walletData: 'wallet_data2',
  walletProvider: WalletProviderEnum.GooglePay,
  authCode: 'abc123',
  checkinDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCForceWallet(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcRefundKeyedRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCRefund(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcRefundPrevTrxnRequest = {
  previousTransactionId: '11e95f8ec39de8fbdb0a4f1a',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCRefundPreviousTransaction(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcRefundTerminalRequest = {
  locationId: '11e95f8ec39de8fbdb0a4f1a',
  transactionAmount: 1,
  terminalId: '11e95f8ec39de8fbdb0a4f1a',
  checkinDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCRefundTerminal(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcRefundTicketRequest = {
  transactionAmount: 1,
  ticketId: '11e95f8ec39de8fbdb0a4f1a',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCRefundTicket(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcRefundTokenRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCRefundTokenized(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcRefundWalletRequest = {
  transactionAmount: 1,
  walletData: 'wallet_data2',
  walletProvider: WalletProviderEnum.GooglePay,
  checkinDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCRefundWallet(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcSaleKeyedRequest = {
  transactionAmount: 1,
  accountNumber: '5454545454545454',
  expDate: '0722',
  checkinDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCSale(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcSalePrevTrxnRequest = {
  previousTransactionId: '11e95f8ec39de8fbdb0a4f1a',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCSalePreviousTransaction(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcSaleTerminalRequest = {
  locationId: '11e95f8ec39de8fbdb0a4f1a',
  transactionAmount: 1,
  terminalId: '11e95f8ec39de8fbdb0a4f1a',
  checkinDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCSaleTerminal(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcSaleTicketRequest = {
  transactionAmount: 1,
  ticketId: '11e95f8ec39de8fbdb0a4f1a',
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCSaleTicket(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcSaleTokenRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCSaleTokenized(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsCcSaleWalletRequest = {
  transactionAmount: 1,
  walletData: 'wallet_data2',
  walletProvider: WalletProviderEnum.GooglePay,
  checkinDate: '2021-12-01',
...
try {
  // @ts-expect-error: unused variables
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { result, ...httpResponse } = await transactionsCreditCardController.cCSaleWallet(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
