...
import { PaymentMethodEnum, paymentMethodEnumSchema } from './paymentMethodEnum';
...
export const achProductTransactionSchema: Schema<AchProductTransaction> = expandoObject(
  {
    ...
    title: ['title', string()],
    paymentMethod: ['payment_method', paymentMethodEnumSchema],
    ...
    level3Default: ['level3_default', optional(unknown())],
    cauSubscribeTypeId: [
    ...
    batchRiskConfig: ['batch_risk_config', optional(unknown())],
