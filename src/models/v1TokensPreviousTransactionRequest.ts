...
import {
  ...
  v1TokensPreviousTransactionRequestAccountNumberSchema,
} from './containers/v1TokensPreviousTransactionRequestAccountNumber';
import {
...
export interface V1TokensPreviousTransactionRequest {
  ...
  /** Account number */
  accountNumber?: V1TokensPreviousTransactionRequestAccountNumber | null;
  /** Terms agreement. */
  termsAgree?: boolean;
...
export const v1TokensPreviousTransactionRequestSchema: Schema<V1TokensPreviousTransactionRequest> = expandoObject(
  {
    ...
    accountNumber: [
      'account_number',
      optional(nullable(v1TokensPreviousTransactionRequestAccountNumberSchema)),
    ],
