...
import { Conditions16, conditions16Schema } from '../conditions16';
import { Conditions171, conditions171Schema } from '../conditions171';
...
export type Joi17Conditions = Conditions16 | Conditions171 | Conditions4 | Conditions41 | Conditions42 | Conditions43;

export const joi17ConditionsSchema: Schema<Joi17Conditions> = anyOf([
  conditions16Schema,
  conditions171Schema,
  conditions4Schema,
  conditions41Schema,
...
export namespace Joi17Conditions {
  /**
  * Validation method to narrow down union type to Conditions16 type case.
  *
  * This is Conditions16 case.
  */
  export function isConditions16(value: unknown): value is Conditions16 {
    const validationResult = validateAndMap(value, conditions16Schema);
    return validationResult.errors === false;
  }

  /**
  * Validation method to narrow down union type to Conditions171 type case.
  *
  * This is Conditions171 case.
  */
  export function isConditions171(value: unknown): value is Conditions171 {
    const validationResult = validateAndMap(value, conditions171Schema);
    return validationResult.errors === false;
  }
