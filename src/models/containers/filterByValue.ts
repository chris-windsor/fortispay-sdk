...
export namespace FilterByValue {
  ...
  */
  export function isFilterByValueCase0(value: unknown): value is FilterByValueCase0 {
  ...
  */
  export function isFilterByValueCase1(value: unknown): value is FilterByValueCase1 {
