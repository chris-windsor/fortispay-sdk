...
import { Conditions161, conditions161Schema } from '../conditions161';
...
export type Joi16Conditions = Conditions16 | Conditions161 | Conditions4 | Conditions41 | Conditions42 | Conditions43;

export const joi16ConditionsSchema: Schema<Joi16Conditions> = anyOf([
  conditions16Schema,
  conditions161Schema,
  conditions4Schema,
  conditions41Schema,
...
export namespace Joi16Conditions {
  /**
  ...
  */
  ...
  /**
  * Validation method to narrow down union type to Conditions161 type case.
  *
  * This is Conditions161 case.
  */
  export function isConditions161(value: unknown): value is Conditions161 {
    const validationResult = validateAndMap(value, conditions161Schema);
    return validationResult.errors === false;
  }
