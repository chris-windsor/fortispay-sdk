...
import {
  ...
  v1ElementsTransactionIntentionRequestAmountSchema,
} from './containers/v1ElementsTransactionIntentionRequestAmount';
import {
...
export interface V1ElementsTransactionIntentionRequest {
  ...
  amount?: V1ElementsTransactionIntentionRequestAmount;
...
export const v1ElementsTransactionIntentionRequestSchema: Schema<V1ElementsTransactionIntentionRequest> = expandoObject(
  {
    ...
    amount: [
      'amount',
      optional(v1ElementsTransactionIntentionRequestAmountSchema),
    ],
    taxAmount: [
      'tax_amount',
