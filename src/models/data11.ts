...
export interface Data11 {
  ...
  brandingDomain?: unknown;
  /** Product Transactions array */
  productTransactions: unknown[];
  /** Product file array */
  productFile?: unknown;
  /** Product Token array */
  productAccountvault?: unknown;
  /** Product recurring array */
  productRecurring?: unknown;
  /** Tags array */
  tags: unknown[];
  /** Terminals array */
  terminals: unknown[];
...
export const data11Schema: Schema<Data11> = expandoObject({
  ...
  brandingDomain: ['branding_domain', optional(unknown())],
  productTransactions: ['product_transactions', array(unknown())],
  productFile: ['product_file', optional(unknown())],
  productAccountvault: ['product_accountvault', optional(unknown())],
  productRecurring: ['product_recurring', optional(unknown())],
  tags: ['tags', array(unknown())],
  terminals: ['terminals', array(unknown())],
});
