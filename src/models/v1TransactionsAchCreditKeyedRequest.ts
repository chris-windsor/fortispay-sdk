...
import { AccountType11Enum, accountType11EnumSchema } from './accountType11Enum';
...
import {
  ...
  identityVerification18Schema,
} from './identityVerification18';
...
export interface V1TransactionsAchCreditKeyedRequest {
  ...
  identityVerification?: IdentityVerification18;
...
export const v1TransactionsAchCreditKeyedRequestSchema: Schema<V1TransactionsAchCreditKeyedRequest> = expandoObject(
  {
    ...
    identityVerification: [
      ...
      optional(lazy(() => identityVerification18Schema)),
    ],
    ...
    accountType: ['account_type', accountType11EnumSchema],
