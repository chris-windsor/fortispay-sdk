...
import {
  ...
  v1TokensCcRequest1AccountNumberSchema,
} from './containers/v1TokensCcRequest1AccountNumber';
import {
...
export interface V1TokensCcRequest1 {
  ...
  /** Account number */
  accountNumber?: V1TokensCcRequest1AccountNumber | null;
  /** Terms agreement. */
  termsAgree?: boolean;
...
export const v1TokensCcRequest1Schema: Schema<V1TokensCcRequest1> = expandoObject(
  {
    ...
    accountNumber: [
      'account_number',
      optional(nullable(v1TokensCcRequest1AccountNumberSchema)),
    ],
