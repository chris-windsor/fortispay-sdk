...
import {
  ...
  accountVaultAccountNumberSchema,
} from './containers/accountVaultAccountNumber';
import {
...
import {
  PaymentMethod13Enum,
  paymentMethod13EnumSchema,
} from './paymentMethod13Enum';
...
export interface AccountVault {
  ...
  /** Account number */
  accountNumber?: AccountVaultAccountNumber | null;
  /** Terms agreement. */
  termsAgree?: boolean;
  ...
  paymentMethod: PaymentMethod13Enum;
...
export const accountVaultSchema: Schema<AccountVault> = expandoObject({
  ...
  accountNumber: [
    'account_number',
    optional(nullable(accountVaultAccountNumberSchema)),
  ],
  ...
  cauSummaryStatusId: ['cau_summary_status_id', cauSummaryStatusIdEnumSchema],
  ...
  firstSix: ['first_six', string()],
  hasRecurring: ['has_recurring', boolean()],
  lastFour: ['last_four', string()],
  modifiedTs: ['modified_ts', number()],
  paymentMethod: ['payment_method', paymentMethod13EnumSchema],
