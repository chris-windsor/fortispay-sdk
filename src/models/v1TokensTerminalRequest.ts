...
import {
  ...
  v1TokensTerminalRequestAccountNumberSchema,
} from './containers/v1TokensTerminalRequestAccountNumber';
import {
...
export interface V1TokensTerminalRequest {
  ...
  /** Account number */
  accountNumber?: V1TokensTerminalRequestAccountNumber | null;
  /** Terms agreement. */
  termsAgree?: boolean;
...
export const v1TokensTerminalRequestSchema: Schema<V1TokensTerminalRequest> = expandoObject(
  {
    ...
    accountNumber: [
      'account_number',
      optional(nullable(v1TokensTerminalRequestAccountNumberSchema)),
    ],
